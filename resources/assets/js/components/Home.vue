<template>
    <div>
        <nav class="panel column is-offset-2 is-8">
            <p class="panel-heading">
                ...
                <span class="is-pulled-right" v-if="loading">
                    <i class="fa fa-refresh fa-spin fa-2x fa-fx"></i>
                </span>
            </p>
        ...
        <Add :openmodel="addActive" @closeApp="close"></Add>
        <Show :openmodel="showActive" @closeApp="close"></Show>
        <Update :openmodel="updateActive" @closeApp="close"></Update>
    </div>
</template>
